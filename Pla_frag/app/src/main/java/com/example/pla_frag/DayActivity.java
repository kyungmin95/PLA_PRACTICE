...
import com.example.pla_frag.Day.DayAdapter;
import com.example.pla_frag.Day.DayDB;
import com.example.pla_frag.Day.DayDiaryActivity;
import com.example.pla_frag.Day.DayDiaryDB;
import com.example.pla_frag.Day.DayTodolistActivity;
...
public class DayActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dayMemo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent memoIntent = new Intent(DayActivity.this, DayDiaryActivity.class);
    ...
    public void setDayTodolist() { //todolist 에 DB 내용에서 가져온 content 값을 가져옴.
        ...
        Cursor c = db.rawQuery("select _id, content, checked from pladaytodo_e where date = '"+ dd + "';", null);
        while(c.moveToNext()) {
    ...
    public void setDayMemo() { //일기 화면에 DB에서 가져온 memocont 값을 가져옴.
        ...
        Cursor c = db.rawQuery("select dicont from pladaydi_ex where date = '"+ dd + "';", null);
        while(c.moveToNext()) {
